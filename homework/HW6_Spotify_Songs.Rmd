...
** In order to find this, I also want to take a look at the median. **
...
** Just by looking at the histogram, you can make an educated guess that the distribution is skewed more to the right based on the higher count of more "danceable" songs, but the median shows us that it is in fact skewed further than the mean shows. We can infer based on these findings that the majority of songs in our dataset are viewed as very "danceable" songs. **
