...
```{r}
eminem <- read_csv("https://raw.githubusercontent.com/dwillis/jour405/refs/heads/main/data/mandms.csv")
```
...
** The two sets of means and standard deviations were pretty off from one another. It's to be expected, since it's a small sample of a small population. **
...
** Like I said above, this particular dataset is a little tricky since the population is pretty small. However, it doesn't negatively impact the act of random sampling, since we've seen it used much more effectively in other examples. **
