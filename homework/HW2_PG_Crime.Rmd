...
**I think the first thing we'd have to explore is gaining clarification on what specific differences there are between the classifications of crimes. What specific threshold needs to be met to categorize a robbery as commercial versus residential?**

**I wouldn't go to say that there should be any that we ignore, because crimes are crimes regardless of their severity. However, there should be a bit more focus on the more violent ones, such as assault with a weapon/shooting, homicide, sex offense, etc.**
...
**Interestingly enough, the three categories with the highest averages all involve vehicles: accidents, automobile stolen, or theft from an automobile. The three with the lowest are residential robbery, homicide, and breaking & entering (other). This data suggests that the crime in PG county, at least in 2024, was predominantly not violent. The only question that rises to my head is how many incidents go unreported and are not within our data set?**
...
**While there was an increase in certain categories of crime in the summer months, there was also a decrease in others. We aren't able to say that crime in general increases during the summer months because of this. However, the most notable part of that finding is the change in average homicides. Across all three months, the number of homicides grew substantially compared to the year's average, which can't be said for many other crimes.**
...
**Summer months prove to be the most dangerous in Prince George's County.**

**While the majority of crime in PG County was not violent in 2024, data shows that homicides grew substantially in June, July, and August.**
