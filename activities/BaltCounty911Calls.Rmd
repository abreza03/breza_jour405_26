...
** Just looking at this, there aren't many distinguishable patterns. The only ones I noticed that made sense were New Years' Day, 2023, and 4/20 in 2022, days known for substance abuse. If I were to draw lines highlighting unusual days, the top three would be included, as well as the days where only one call was placed. Outliers aside, I feel like we'd need more nuance to understand why certain days with no holiday or ingrained use of substances had the number of calls they did. **
...
** I think my initial observation of looking for holidays was a strong start, because we can see that both New Years' Day and 4/20 are on this shortened list. A new observation is the particularly low number of calls on Veteran's Day, another national holiday where most people stay home from work. In terms of the other dates, more research would be needed to determine why there were either an unusual high/low amount of calls, as none of the dates stick out for holidays. This further research could include: Was it a Ravens/Orioles home game day? Is there a more niche holiday/celebration specific to Baltimore on any of these days? What day of the week was it? Etc. **
...
** Data shows that 911 calls placed for overdoses in Baltimore County are more prevalent on Fridays and Saturdays, but not by as much as one might expect. **
...
** I think one potential angle, similar to our PG County murder/heat claim, is that on average, the number of 911 calls for overdoses are higher in warmer months. It's not an exact fit, but it's interesting that the numbers jump & fall slightly in the months where Spring begins and Fall ends. Next steps would include some more research into some of the topics I suggested earlier, such as gamedays, local holidays, etc. As of right now, I don't think there's enough here to warrant a story regarding a correlation between specific events outside of the aforementioned obvious ones (New Years, 4/20), but further research could change that. **
